...
$(document).ready(function () {
  ...
  var newImage =  'examples/img/flower-e835b90920_640.jpg';

$.getJSON('https://pixabay.com/api/?key=723985-f0607cc184e713148830b2d21&q=flower&page='+ randomNum +'&per_page=3&image_type=photo',
    function(data){
      $.each(data.hits, function(i,item){
      newImage =  item.webformatURL ;

      //$('#example-images').html('<img src="' + newImage + ')"/>');
